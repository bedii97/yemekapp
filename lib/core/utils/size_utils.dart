...
extension ResponsiveExtension on num {
  ...
  double get ofHeight => toDouble() * mediaQueryData.size.height;

  double get ofTopHeight => (this * mediaQueryData.viewPadding.top);

  double get ofBottomHeight => (this * mediaQueryData.viewPadding.bottom);

  double get ofSafeHeight => (toDouble() * _height);

  //Kusursuz çalışıyor
  double get ofWidth => (this * mediaQueryData.size.width);
